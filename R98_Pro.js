...
export function Shutdown() {
    let packet = new Array(520).fill(0);
    
    // Relevant part of hardware mode (rainbow) dump
    let hardwareModeData = [
        0x09, 0x04, 0x00, 0x00, 0x01, 0x00, 0x80, 0x00, 0x00, 0x00, 0x04, 0x04, // 0x20
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x30
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09, 0x10, 0x00, 0x03, 0x07, 0x14, // 0x40
        0x03, 0x01, 0x00, 0x04, 0x01, 0x01, 0x07, 0x04, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x50
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x11, 0x00, 0x00, 0x00, 0x00, // 0x60
        0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0x04, 0x17, 0x04, 0x17, 0x04, 0x17, 0xff, 0xff, 0x14, // 0x70
        0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, // 0x80
        0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x17, 0x14, // 0x90
        0x17, 0x14, 0x17, 0x14, 0x17, 0x14, 0x14, 0x14, 0x14, 0x14, 0x5a, 0xa5  // 0xA0
    ];

    // Copy hardware data into packet
    for (let i = 0; i < hardwareModeData.length; i++) {
        packet[i] = hardwareModeData[i];
    }

    // Send packet to revert to HW lighting
